...
Traditional ML</sub>2</sub> pipeline: design and obtain features for all training data regrading nodes, links and graphs, then train ML model to apply it to make a prediction.
